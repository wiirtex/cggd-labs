...
void cg::renderer::rasterization_renderer::init() {
    ...
    rasterizer->set_viewport(settings->width,
                             settings->height);
    ...
    camera->set_width(floor(settings->width));
...
void cg::renderer::rasterization_renderer::render() {
    ...
    rasterizer->clear_render_target({123, 131, 61});
    ...
    std::cout << "Clearing took " << rendering_duration.count() << "ms" << std::endl;
